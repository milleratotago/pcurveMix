...
# NEWROLF: Here is another plot with our "old" random function and the cdfs match
# in this case.
old_p_values <- pcurveMix::random(n_replic, mu = mu_c, sigma = sigma_c, pi = pi, alpha = alpha_cutoff, tails = 2)
plot(ecdf(old_p_values), main = "Old method")
lines(p_seq,pred_cdf)
